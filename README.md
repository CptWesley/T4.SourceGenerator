...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="T4.SourceGenerator" Version="1.3.0" PrivateAssets="all" />
  </ItemGroup>
...
## Licensing
The source code is fully [MIT licensed](https://github.com/CptWesley/T4.SourceGenerator/blob/master/LICENSE).

## Contribution
Any help is welcome. Feel free to open [issues or feature requests](https://github.com/CptWesley/T4.SourceGenerator/issues) or create a [pull request](https://github.com/CptWesley/T4.SourceGenerator/pulls).
